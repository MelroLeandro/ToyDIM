    ...
    for j=1:4
        ...
        for ii=1:Bodies.(bodyName).NumFixedFrameNodes
            if count == Bodies.(bodyName).FixedFrameNodeOrder(ii)
                ...
                Bodies.(bodyName).node.(node2).idx = countd;
            else
...
%        Bodies.(bodyName).node.(node).deltaP=[0.01*(i+j-2),0.0,0.0]';
        ...
        % system masses and geometry
        Bodies.(bodyName).node.(node2).m=0.001;      % node mass
        Bodies.(bodyName).node.(node2).mu=0.001;      % local rot inertia
        Bodies.(bodyName).node.(node2).charge=0;     % node charge
        Bodies.(bodyName).node.(node2).x=[0.5,i*.5,j*.5]';  % nodal angular relative velocity
%        Bodies.(bodyName).node.(node2).deltaP=[0.01*(i+j-2),0,0.0]';
         if i==1
             Bodies.(bodyName).node.(node2).deltaP=[0,0.1,0.1]';  % relative displacement
         else
             Bodies.(bodyName).node.(node2).deltaP=[0,0,0]';
         end
        Bodies.(bodyName).node.(node2).w=[0,0,0]';
        Bodies.(bodyName).node.(node2).deltaP_d=[0,0,0]';
        Bodies.(bodyName).node.(node2).omegaP=[0,0,0]';  % nodal angular relative velocity
        Bodies.(bodyName).node.(node2).omegaP_d=[0,0,0]';
        % node lattice external forces
        Bodies.(bodyName).node.(node2).f=[0,0,0]'; % linear
        Bodies.(bodyName).node.(node2).n=[0,0,0]'; % rotational
...
Bodies.(bodyName).node.C1x1.Nei={'C1x2','C2x1','R1x1'};
Bodies.(bodyName).node.C1x1.num=3;
Bodies.(bodyName).node.C1x2.Nei={'C1x1','C1x3','C2x2','R1x2'};
Bodies.(bodyName).node.C1x2.num=4;
Bodies.(bodyName).node.C1x3.Nei={'C1x2','C1x4','C2x3','R1x3'};
Bodies.(bodyName).node.C1x3.num=4;
Bodies.(bodyName).node.C1x4.Nei={'C1x3','C2x4','R1x4'};
Bodies.(bodyName).node.C1x4.num=3;
Bodies.(bodyName).node.C2x1.Nei={'C1x1','C2x2','C3x1','R2x1'};
Bodies.(bodyName).node.C2x1.num=4;
Bodies.(bodyName).node.C2x2.Nei={'C1x2','C2x1','C2x3','C3x2','R2x2'};
Bodies.(bodyName).node.C2x2.num=5;
Bodies.(bodyName).node.C2x3.Nei={'C1x3','C2x2','C2x4','C3x3','R2x3'};
Bodies.(bodyName).node.C2x3.num=5;
Bodies.(bodyName).node.C2x4.Nei={'C1x4','C2x3','C3x4','R2x4'};
Bodies.(bodyName).node.C2x4.num=4;
Bodies.(bodyName).node.C3x1.Nei={'C2x1','C3x2','C4x1','R3x1'};
Bodies.(bodyName).node.C3x1.num=4;
Bodies.(bodyName).node.C3x2.Nei={'C2x2','C3x1','C3x3','C4x2','R3x2'};
Bodies.(bodyName).node.C3x2.num=5;
Bodies.(bodyName).node.C3x3.Nei={'C2x3','C3x2','C3x4','C4x3','R3x3'};
Bodies.(bodyName).node.C3x3.num=5;
Bodies.(bodyName).node.C3x4.Nei={'C2x4','C3x3','C4x4','R3x4'};
Bodies.(bodyName).node.C3x4.num=4;
Bodies.(bodyName).node.C4x1.Nei={'C3x1','C4x2','R4x1'};
Bodies.(bodyName).node.C4x1.num=3;
Bodies.(bodyName).node.C4x2.Nei={'C3x2','C4x1','C4x3','R4x2'};
Bodies.(bodyName).node.C4x2.num=4;
Bodies.(bodyName).node.C4x3.Nei={'C3x3','C4x2','C4x4','R4x3'};
Bodies.(bodyName).node.C4x3.num=4;
Bodies.(bodyName).node.C4x4.Nei={'C3x4','C4x3','R4x4'};
Bodies.(bodyName).node.C4x4.num=3;

Bodies.(bodyName).node.R1x1.Nei={'R1x2','R2x1','C1x1'};
Bodies.(bodyName).node.R1x1.num=3;
Bodies.(bodyName).node.R1x2.Nei={'R1x1','R1x3','R2x2','C1x2'};
Bodies.(bodyName).node.R1x2.num=4;
Bodies.(bodyName).node.R1x3.Nei={'R1x2','R1x4','R2x3','C1x3'};
Bodies.(bodyName).node.R1x3.num=4;
Bodies.(bodyName).node.R1x4.Nei={'R1x3','R2x4','C1x4'};
Bodies.(bodyName).node.R1x4.num=3;
Bodies.(bodyName).node.R2x1.Nei={'R1x1','R2x2','R3x1','C2x1'};
Bodies.(bodyName).node.R2x1.num=4;
Bodies.(bodyName).node.R2x2.Nei={'R1x2','R2x1','R2x3','R3x2','C2x2'};
Bodies.(bodyName).node.R2x2.num=5;
Bodies.(bodyName).node.R2x3.Nei={'R1x3','R2x2','R2x4','R3x3','C2x3'};
Bodies.(bodyName).node.R2x3.num=5;
Bodies.(bodyName).node.R2x4.Nei={'R1x4','R2x3','R3x4','C2x4'};
Bodies.(bodyName).node.R2x4.num=4;
Bodies.(bodyName).node.R3x1.Nei={'R2x1','R3x2','R4x1','C3x1'};
Bodies.(bodyName).node.R3x1.num=4;
Bodies.(bodyName).node.R3x2.Nei={'R2x2','R3x1','R3x3','R4x2','C3x2'};
Bodies.(bodyName).node.R3x2.num=5;
Bodies.(bodyName).node.R3x3.Nei={'R2x3','R3x2','R3x4','R4x3','C3x3'};
Bodies.(bodyName).node.R3x3.num=5;
Bodies.(bodyName).node.R3x4.Nei={'R2x4','R3x3','R4x4','C3x4'};
Bodies.(bodyName).node.R3x4.num=4;
Bodies.(bodyName).node.R4x1.Nei={'R3x1','R4x2','C4x1'};
Bodies.(bodyName).node.R4x1.num=3;
Bodies.(bodyName).node.R4x2.Nei={'R3x2','R4x1','R4x3','C4x2'};
Bodies.(bodyName).node.R4x2.num=4;
Bodies.(bodyName).node.R4x3.Nei={'R3x3','R4x2','R4x4','C4x3'};
Bodies.(bodyName).node.R4x3.num=4;
Bodies.(bodyName).node.R4x4.Nei={'R3x4','R4x3','C4x4'};
Bodies.(bodyName).node.R4x4.num=3;
...
% Points in body C1
Bodies.C1.PointsList    = {'C1x1'};   % this is the fixed node
Bodies.C1.Points.C1x1.sPp = Bodies.C1.node.C1x1.xP; % local frame coordinates
...
Bodies.C1.p_d = [0,0,0,0]';  % Euler parameters derivative
