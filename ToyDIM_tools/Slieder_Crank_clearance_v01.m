...
%------------------------------Multibody Dynamic--------------------------%
%------------------------------A toy system-------------------------------% 
% Problem:  3D slider-crank with clearance
...
Joints.J2.type='NormalV0';   % body_1 and body_2 mode in a plane normal to V0
Joints.J2.body_1='C1'; % body_1 identifier
Joints.J2.body_2='C2'; % body_2 identifier
Joints.J2.point='P2';  % point identifier
Joints.J2.PotencialGrad=@(P1,P2)(norm(P1-P2)>.002)*1000*[0; P2(2)-P1(2); P2(3)-P1(3)];%;/norm(P1-P2);  % Joint potencial gradiente
%Joints.J2.PotencialGrad=@(P1,P2)12*(.01)^12*(norm(P1-P2))^-13+6*(.01)^6*(norm(P1-P2))^-7*[0; P2(2)-P1(2); P2(3)-P1(3)]/norm(P1-P2);
%Joints.J2.PotencialGrad=@(P1,P2)(norm(P1-P2)<.1).*(12*(.1)^12*(.15-norm(P1-P2)).^-13-6*(.1)^6*(.15-norm(P1-P2)).^-7);
