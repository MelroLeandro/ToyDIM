...
Joints.J2.type='Rev2';  %'NormalV0';   % body_1 and body_2 mode in a plane normal to V0
Joints.J2.body_1='C1'; % body_1 identifier
Joints.J2.body_2='C2'; % body_2 identifier
Joints.J2.point='P2';  % point identifier

Joints.J2.PotencialGrad=@(P1,P2)(norm(P1-P2)>.002)*[P2(1)-P1(1); P2(2)-P1(2); P2(3)-P1(3)]; % Joint potencial gradiente
...
tic
[T, yT]= ode45(@updateaccelDiff, tspan, y_d, options);
timeode45=toc
